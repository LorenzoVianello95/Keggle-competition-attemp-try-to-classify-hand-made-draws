...
if __name__ == "__main__":
    ...
    parser.add_argument("--train", default="data_npz/train_.npz", required=False, help="Train .npz file that stores tensors used to train the network")
    parser.add_argument("--test", default="data_npz/dev_.npz", required=False, help="Test .npz file that stores tensors used to train the network")
    ...
    parser.add_argument("--epochs1", default=3, type=int, help="Up to which epoch to train the LSTM for the first stage (default=10)")
    parser.add_argument("--epochs2", default=4, type=int, help="Up to which epoch to train the LSTM for the second stage (default=15)")
    ...
    train_videos = npzfile["images"]
    train_classes = npzfile["images_y"]

    # Load tensors (test):
    npzfile = np.load(args.test)
    test_videos = npzfile["images"]
    test_classes = npzfile["images_y"]
    ...
    with tf.Session() as sess:
        ...
        print(videoClassifier.checkpoint_folder)
